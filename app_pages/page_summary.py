...
def summary_body():
    ...
    st.success('''
        ...
        * 1 - The client is interested in having a study to differentiate 
        a fractured from a healthy bone visually.\n
        * 2 - The client is interested in telling whether a given bone is fractured or not.\n''')
    
    st.write('''
        For additional information, please visit and read the 
        [Project README file](https://github.com/ObiWanBonobi/Bone-Fracture-Detection/blob/main/README.md).''')
